---
title: TypeScript配置
date: 2021-01-04 15:16:58
permalink: /pages/0bea56/
meta:
  - name: keywords
  - content: 前端,JavaScript,TypeScript,ts,TypeScript配置,ts配置,tsconfig.json,tsconfig
categories:
  - 前端
  - TypeScript
tags:
...
- 生成`tsconfig.json` 配置文件的命令：`tsc --init`
