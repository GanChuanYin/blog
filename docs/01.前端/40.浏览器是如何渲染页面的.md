...
![](https://gitee.com/gan_chuan_yin/blog-image/raw/master/img/20220207143417.png)
...
![](https://gitee.com/gan_chuan_yin/blog-image/raw/master/img/20220207150513.png)
...
![](https://gitee.com/gan_chuan_yin/blog-image/raw/master/img/20220207160645.png)
...
![](https://gitee.com/gan_chuan_yin/blog-image/raw/master/img/servicfication.svg)
...
![](https://gitee.com/gan_chuan_yin/blog-image/raw/master/img/20220207162517.png)
...
![](https://gitee.com/gan_chuan_yin/blog-image/raw/master/img/20220208105840.png)

#### 2.开始导航

当用户点击回车时，UI 线程会发起网络调用以获取网站内容。加载旋转器显示在选项卡的角落，网络线程会通过适当的协议，如 DNS 查找和为请求建立 TLS 连接。

![](https://gitee.com/gan_chuan_yin/blog-image/raw/master/img/20220208105913.png)
...
![](https://gitee.com/gan_chuan_yin/blog-image/raw/master/img/20220208110333.png)

如果响应是 HTML 文件，那么下一步是将数据传递给渲染器进程，但如果是 zip 文件或其他文件，则这意味着这是一个下载请求，因此他们需要将数据传递给下载管理器。

![](https://gitee.com/gan_chuan_yin/blog-image/raw/master/img/20220208110406.png)

> 这也是安全浏览检查发生的地方。如果域和响应数据似乎与已知的恶意网站匹配，则网络线程会发出警报以显示警告页面

![](https://gitee.com/gan_chuan_yin/blog-image/raw/master/img/20220208110605.png)

#### 4.查找渲染器进程

一旦所有检查完成，并且网络线程确信浏览器应该导航到请求的网站，网络线程就会告诉 UI 线程数据已准备就绪。然后，UI 线程找到一个渲染器进程来进行网页的渲染。

![](https://gitee.com/gan_chuan_yin/blog-image/raw/master/img/20220208111056.png)
...
![](https://gitee.com/gan_chuan_yin/blog-image/raw/master/img/20220208111410.png)
...
![](https://gitee.com/gan_chuan_yin/blog-image/raw/master/img/20220208112026.png)
...
![](https://gitee.com/gan_chuan_yin/blog-image/raw/master/img/20220208234911.png)
...
![](https://gitee.com/gan_chuan_yin/blog-image/raw/master/img/20220208235230.png)
...
![](https://gitee.com/gan_chuan_yin/blog-image/raw/master/img/20220209000146.png)
...
![](https://gitee.com/gan_chuan_yin/blog-image/raw/master/img/20220209000236.png)
...
![](https://gitee.com/gan_chuan_yin/blog-image/raw/master/img/20220209000331.png)
...
![](https://gitee.com/gan_chuan_yin/blog-image/raw/master/img/20220209000632.png)

下图页面元素按 HTML 标记顺序出现，导致渲染错误的图像，因为没有考虑 z 索引
![](https://gitee.com/gan_chuan_yin/blog-image/raw/master/img/20220209000740.png)

在这个绘制步骤中，主线程在布局树上行走以创建绘制记录。绘画记录是绘画过程的注释，如“先背景，然后是文本，然后是矩形”。如果你使用 JavaScript 绘制了 canvas 元素，你可能熟悉此过程。

![](https://gitee.com/gan_chuan_yin/blog-image/raw/master/img/20220209000841.png)

#### 8.更新渲染管道成本高昂

在渲染管道时，最重要的是，在每个步骤中，上一个操作的结果都用于创建新数据。例如，如果布局树有变化，则需要为文档中受影响的部分重新生成绘制顺序。

![](https://gitee.com/gan_chuan_yin/blog-image/raw/master/img/Feb-09-2022-00-10-31.gif)
...
![](https://gitee.com/gan_chuan_yin/blog-image/raw/master/img/20220209001253.png)

即使你的渲染操作跟上屏幕刷新，这些计算也在主线程上运行，这意味着当你的应用程序运行 JavaScript 时，它可能会被阻止。

![](https://gitee.com/gan_chuan_yin/blog-image/raw/master/img/20220209001352.png)

你可以使用 requestAnimationFrame()将 JavaScript 操作划分为小块和计划在每个帧上运行。

![](https://gitee.com/gan_chuan_yin/blog-image/raw/master/img/20220209001435.png)
...
![](https://gitee.com/gan_chuan_yin/blog-image/raw/master/img/Feb-09-2022-00-17-30.gif)

合成是一种将页面的部分分开分层、单独光栅化并在称为合成器线程的单独线程中复合为页面的技术。

如果发生滚动，由于图层已经光栅化，它所要做的就是复合一个新的框架。通过移动图层和合成新帧，动画也可以以同样的方式实现。

![](https://gitee.com/gan_chuan_yin/blog-image/raw/master/img/Feb-09-2022-00-19-27.gif)
...
![](https://gitee.com/gan_chuan_yin/blog-image/raw/master/img/20220209002047.png)
...
![](https://gitee.com/gan_chuan_yin/blog-image/raw/master/img/20220209002156.png)
...
![](https://gitee.com/gan_chuan_yin/blog-image/raw/master/img/20220209002308.png)
...
![](https://gitee.com/gan_chuan_yin/blog-image/raw/master/img/20220209101319.png)
...
![](https://gitee.com/gan_chuan_yin/blog-image/raw/master/img/20220209101749.png)
...
![](https://gitee.com/gan_chuan_yin/blog-image/raw/master/img/20220209102123.png)
...
![](https://gitee.com/gan_chuan_yin/blog-image/raw/master/img/20220209102923.png)
...
![](https://gitee.com/gan_chuan_yin/blog-image/raw/master/img/20220209103437.png)
...
下图：时间线事件导致页面卡顿
![](https://gitee.com/gan_chuan_yin/blog-image/raw/master/img/20220209103550.png)
...
![](https://gitee.com/gan_chuan_yin/blog-image/raw/master/img/20220209103739.png)
...
![](https://gitee.com/gan_chuan_yin/blog-image/raw/master/img/20220209104009.png)
